...
import { LinePostList } from 'components/common/post';
import PostPlainTemplate from 'components/base/template/PostPlainTemplate';
  ...
  render() {
    ...
    return (
      <PostPlainTemplate
        title={type}
      >
        {filterList && <FilterMenu list={filterList} />}
        <LinePostList
          list={LineList}
        />
      </PostPlainTemplate>
