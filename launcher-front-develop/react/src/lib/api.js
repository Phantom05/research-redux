...
const endPoint ={
  ...
  post_reset_verify_email : `/launcher/api/user/email/check`,
...
export function postGetWorksSearchList(payload){
  console.log(`>>>postGetWorksSearchList`);
  console.log(payload);
  // post_listing_work_search_list
  const axiosConf={
...
export function postWorkspaceGet(payload){
  ...
  const axiosConf ={
    ...
    url: `${testIp}/users/launcher/my/workspace`,
    method: 'post',
    data: payload
  }
  // setHeader(axiosConf);
...
export function postWorkspaceSet(payload){
  ...
  const axiosConf ={
    ...
    url: `${testIp}/users/launcher/my/workspace/change`,
    method: 'post',
    data: payload
  }
  // setHeader(axiosConf);
